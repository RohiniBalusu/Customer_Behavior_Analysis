...
EDA was performed to understand customer purchasing behavior using statistical summaries and visualizations.

4. SQL Analysis

The cleaned dataset was imported into a SQL database and analyzed using SQL queries to extract insights such as:
...
Charts and plots were created to visualize patterns and trends in the dataset.

6. Power BI Dashboard

An interactive dashboard was developed in Power BI to present key insights including:
...
Spending patterns across different groups
...
jupyter notebook shopping_behaviour_analysis.ipynb

Run the SQL queries using your preferred database:
